...
public class E3Result implements Serializable {
	...
	private E3Result(Integer status, String msg) {
		this.status = status;
		this.msg = msg;
	}
	
	
	public static E3Result build(Integer status, String message, Object data) {
		return new E3Result(status,message,data);
	}
	...
	public static E3Result error(Integer status,String message) {
		return new E3Result(status,message);
	}
	/**
	...
	public static E3Result build(int status, String message) {
		return new E3Result(status,message);
	}
}
